...
public class FabujiaoanController {
    ...
    */
    ...
    public R update(@RequestBody FabujiaoanEntity fabujiaoan, HttpServletRequest request){
...
//                            fabujiaoanEntity.setFabujiaoanPhoto("");//照片
//                            fabujiaoanEntity.setFabujiaoanTypes(Integer.valueOf(data.get(0)));   //教案类型 要改的
//                            fabujiaoanEntity.setFabujiaoanContent("");//照片
